...
public class ModItems {
    public static final Item CUSTOM_FISH = new CustomFishItem(new Item.Settings().maxCount(64));
    public static final Item COLLECTIBLE_CARD = new CardItem(new Item.Settings().maxCount(16));

    public static final Item CARD_TABLE_ITEM = new BlockItem(ModBlocks.CARD_TABLE_BLOCK, new Item.Settings());
    public static final Item PUZZLE_BLOCK_ITEM = new BlockItem(ModBlocks.PUZZLE_BLOCK, new Item.Settings());
